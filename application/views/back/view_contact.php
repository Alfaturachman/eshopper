        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Name: <?php echo html_escape($contact_message_by_id->contact_name)?> & Email: <?php echo html_escape($contact_message_by_id->contact_email)?></h4>
                   <h4 class="modal-title" id="myModalLabel">Subject:<?php echo html_escape($contact_message_by_id->contact_subject)?></h4>
                </div>
                <div class="modal-body">
                	<strong>Message:</strong><hr/>
                   <?php echo html_escape($contact_message_by_id->contact_message)?>
