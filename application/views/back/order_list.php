                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeC">
                                    <td><?php echo $i;?></td>
                                    <td>#<?php echo html_escape($value->order_id);?></td>
                                    <td><?php echo html_escape($value->cus_name);?></td>
                                    <td><?php echo html_escape($value->cus_mobile);?></td>
                                    <td><?php echo html_escape($value->order_total);?></td>
                                    <td><?php echo html_escape($value->order_status);?></td>
                                    <td><?php echo html_escape($value->payment_status);?></td>
                                   <td>
