                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li>
                            <a href="">
                                <div>
                                    <strong><span class=" label label-danger"><?php echo html_escape($value->contact_name)?></span></strong>
                                    <span class="pull-right text-muted">
                                        <em>
                                            
                                            <?php
                                                 echo html_escape($value->contact_date);
                                ...
                                <div>
                                    <?php $msg = $value->contact_message;
                                        $content = explode(" ",$msg);
                                           ...
                                           echo html_escape(implode(" ", $less_content));
                                    ?>
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            ...
                            <div class="user-info">
                                <div><?php echo html_escape($this->session->username);?></div>
