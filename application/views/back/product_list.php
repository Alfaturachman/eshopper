                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeC">
                                    <td><?php echo $i;?></td>
                                    <td><?php echo html_escape($value->pro_title);?></td>
                                    <td><img src="<?php echo base_url().html_escape($value->pro_image);?>" width="80px" height="80px"/></td>
                                    <td>
                                    ...
                                    <td><?php echo html_escape($value->pro_price);?></td>
                                   <td>
