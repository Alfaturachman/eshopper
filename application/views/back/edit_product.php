                           ...
                           <h5 style='color:red'> <?php echo validation_errors();?></h5>
                             ...
                             <?php echo csrf_field(); ?>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo html_escape($all_product->pro_title)?>" name="pro_title" required="">
                                    <input type="hidden" class="form-control" value="<?php echo html_escape($all_product->pro_id)?>" name="pro_id">
                                </div>
                                 <div class="form-group">
                                    <label>Add Product Description</label>
                                    <textarea  id="ck" class="form-control" rows="3" name="pro_desc">
                                        <?php echo html_escape($all_product->pro_desc)?>
                                    </textarea>
                                        ...
                                        <?php
                                         foreach ($all_cat as $category) {  ?>
                                            <option 
                                                ...
                                                selected="selected";
                                                <?php }?>
                                              value="<?php echo html_escape($category->category_id);?>"><?php echo html_escape($category->category_name)?>
                                        ...
                                        <?php
                                         foreach ($all_sub_cat as $sub_category) {  ?>
                                            <option 
                                                ...
                                                selected="selected";
                                                <?php }?>
                                              value="<?php echo html_escape($sub_category->sub_cat_id);?>"><?php echo html_escape($sub_category->sub_category_name)?>
                                    ...
                                    <select class="form-control" name="pro_brand">
                                        ...
                                        <option
                                            <?php if($all_product->pro_brand==$brand->brand_id){?>
                                                selected="selected";
                                                <?php }?>
                                             value="<?php echo html_escape($brand->brand_id);?>"><?php echo html_escape($brand->brand_name);?>
                                         </option>
                                        <?php } ?>
                                    </select>
                                </div>
                                 <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="<?php echo html_escape($all_product->pro_price)?>" name="pro_price" required="">
                                </div>
                                 <div class="form-group">
                                    <label>Add Product Quantity</label>
                                    <input type="number" class="form-control" value="<?php echo html_escape($all_product->pro_quantity)?>" name="pro_quantity" required="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="old_pro_image" value="<?php echo html_escape($all_product->pro_image)?>">
                                    <img src="<?php echo base_url().html_escape($all_product->pro_image)?>" width="80" height="50"/>
