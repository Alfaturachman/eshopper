<div class="product-details"><!--product-details-->
	<div class="col-sm-5">
		<div class="view-product">
			<img src="<?php echo base_url().html_escape($product_info->pro_image)?>" alt="" />
			<h3>ZOOM</h3>
		</div>
	...
	<div class="col-sm-7">
		<div class="product-information"><!--/product-information-->
			<h2><?php echo html_escape($product_info->pro_title)?></h2>
			<p>Web ID: <?php echo html_escape($product_info->pro_id)?></p>
			<!-- <img src="<?php echo base_url()?>assets/front/images/product-details/rating.png" alt="" /> -->
			<span>
				<form action="<?php echo base_url()?>add-to-cart"  method="post">
					<?php echo csrf_field(); ?>
					<span>$<?php echo html_escape($product_info->pro_price)?></span><!--This is under form because style factor when product price move to form then style is not formating-->
					<label>Quantity:</label>
					<input type="text" value="1" name="qty"/>
					<input type="hidden" value="<?php echo html_escape($product_info->pro_id)?>" name="pro_id"/>
			...
			<p><b>Brand:</b> <?php echo html_escape($product_info->brand_name)?></p>
