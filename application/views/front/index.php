                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                ?>
                                    <li>
                                        <a href="<?php echo base_url() ?>payment"><i class="fa fa-crosshairs"></i>
                                            Checkout</a>
                                ...
                                <?php } elseif ($this->cart->total_items() != Null && $customer_id != NULL) { ?>
                                    ...
                                    <li>
                                        <a href="<?php echo base_url() ?>billing"><i class="fa fa-crosshairs"></i>
                                            Checkout</a>
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <?php if ($customer_id) { ?>
                                            <li>
                                                <a href="<?php echo base_url() ?>logout"><i class="fa fa-lock"></i>
                                                    Logout</a>
                                            </li>
                                        <?php } else { ?>
                                            <li>
                                                <a href="<?php echo base_url() ?>checkout"><i class="fa fa-lock"></i>
                                                    Login</a>
                                            </li>
                                        <?php } ?>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <p class="pull-right">Develop by <span><a target="_blank" href="http://www.sumon-it.com">Sumon
                                Sarker</a></span></p>
                </div>
            </div>
        </div>
